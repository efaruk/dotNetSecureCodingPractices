...
namespace SCP.Configuration
{
    //TODO: Do NOT use hard coded clear text config
    public class AppConfigSettingsProvider : ISettingsProvider
    {
        ...
        {
            return new SettingsPropertyNotFoundException(string.Format("AppSetting '{0}' not found.", key));
        }
    }
}